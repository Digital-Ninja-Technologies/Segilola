...
import faviconUrl from "../assets/segilola-poster.jpg?url";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      // Neutral root defaults — every shareable route overrides these in its own head().
      { title: "Sègilolá (The Villain)" },
      {
        name: "description",
        content:
